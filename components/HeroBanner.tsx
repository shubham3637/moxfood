      ...
      <div className="max-w-7xl mx-auto px-6 py-10 md:py-16 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-pink-600/30 text-pink-300 text-xs font-bold border border-pink-500/40 backdrop-blur-md shadow-sm">
            ...
            <span>SUPER SAVINGS • Online Grocery Store</span>
          </div>

          {/* Main Title */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight leading-[1.15]">
            GAUTAM TRADING <br />
          ...
          <p className="text-blue-100 text-sm md:text-base leading-relaxed max-w-xl font-medium">
            Order fresh <strong>whole wheat flour, edible oil, desi pulses, tea & daily home essentials</strong> at wholesale prices with fast express home delivery.
          </p>
          ...
          <div className="pt-1 flex flex-wrap gap-3 text-xs font-semibold text-blue-100">
            <div className="flex items-center gap-2 bg-blue-900/80 backdrop-blur-md px-3.5 py-2 rounded-xl border border-blue-700/60 shadow-sm">
              ...
              <span>Free Home Delivery (&gt; ₹499)</span>
            </div>
            <div className="flex items-center gap-2 bg-blue-900/80 backdrop-blur-md px-3.5 py-2 rounded-xl border border-blue-700/60 shadow-sm">
          ...
          <div className="pt-3 flex flex-wrap items-center gap-4">
            <button
              ...
              className="bg-pink-600 hover:bg-pink-500 text-white px-8 py-4 rounded-2xl font-black text-sm shadow-xl shadow-pink-600/30 transition-all transform hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2.5 cursor-pointer"
            >
              <ShoppingBag size={20} />
              <span>Shop Grocery Now</span>
            </button>

            <div className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-blue-900/50 border border-blue-700/40 text-xs font-bold text-pink-300">
        ...
        <div className="lg:col-span-5 hidden lg:block">
          <div className="glass-card-dark p-6 rounded-3xl shadow-2xl relative border border-white/15 space-y-4 hover:border-pink-500/50 transition-all duration-300">
            <div className="absolute -top-3.5 -right-3.5 bg-gradient-to-r from-pink-600 to-rose-600 text-white text-xs font-black px-4 py-1.5 rounded-full shadow-lg border border-pink-400/40">
              🔥 SPECIAL COMBO
            </div>

            <div className="flex items-center gap-2 text-pink-300 font-extrabold text-base">
              <span>🌾 Monthly Ration Combo Pack</span>
            </div>

            <p className="text-xs text-blue-200 leading-relaxed font-medium">
              Aashirvaad Chakki Atta + Fortune Oil + Desi Toor Dal + Premium Tea at exclusive combo discount!
            </p>

            <div className="space-y-2 text-xs border-t border-white/10 pt-3 font-semibold">
              <div className="flex justify-between text-blue-100">
                <span>• Whole Wheat Atta (5 kg)</span>
                <span className="font-extrabold text-pink-400">₹365</span>
              </div>
              <div className="flex justify-between text-blue-100">
                <span>• Refined Sunflower Oil (1 Litre)</span>
                <span className="font-extrabold text-pink-400">₹135</span>
              </div>
              <div className="flex justify-between text-blue-100">
                <span>• Desi Toor Dal (1 kg)</span>
                <span className="font-extrabold text-pink-400">₹160</span>
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-white/10 flex justify-between items-center text-xs">
              <div>
                ...
                <span className="text-pink-400 font-black text-sm">₹100+ OFF</span>
              </div>
              <span className="text-[11px] font-extrabold text-pink-300 bg-pink-500/20 px-3 py-1.5 rounded-xl border border-pink-400/30">
                Gautam Trading Guarantee
              </span>
            </div>
          </div>
        </div>
