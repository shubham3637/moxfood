  ...
  if (!order) {
    return (
      <div className="max-w-md mx-auto my-16 p-8 bg-white rounded-3xl text-center border border-slate-200 shadow-sm space-y-4">
        <h2 className="text-xl font-extrabold text-slate-800">Order Not Found</h2>
        <Link href="/" className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-500 text-white text-xs font-bold px-5 py-3 rounded-xl cursor-pointer">
          <Home size={16} />
...
*Delivery Slot:* ${order.customerDetails.deliverySlot}
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      ...
      <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-xl text-center space-y-4 relative overflow-hidden">
        ...
        <div>
          <div className="inline-block bg-blue-100 text-blue-900 text-xs font-extrabold px-3 py-1 rounded-full mb-2 border border-blue-200">
        ...
        <div className="pt-2 flex flex-col sm:flex-row gap-3 justify-center">
          <a
            ...
            className="bg-pink-600 hover:bg-pink-500 text-white font-extrabold px-6 py-3.5 rounded-2xl shadow-lg flex items-center justify-center gap-2 text-xs transition-all cursor-pointer"
          >
          ...
          <Link
            href="/"
            className="bg-blue-900 hover:bg-blue-800 text-white font-bold px-6 py-3.5 rounded-2xl flex items-center justify-center gap-2 text-xs transition-colors cursor-pointer"
          >
            <Home size={16} />
            <span>Back to Home</span>
          </Link>
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100 space-y-1.5">
            ...
            <div className="text-slate-800 font-bold">{order.customerDetails.name}</div>
          ...
          <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100 space-y-1.5">
            ...
            <div className="text-slate-700">
              Delivery Slot: <span className="font-bold text-slate-900">{order.customerDetails.deliverySlot}</span>
            </div>
            <div className="text-slate-700">
        ...
        <div className="space-y-3">
          <h4 className="font-bold text-xs text-slate-700">Ordered Items:</h4>
        ...
        {/* Pricing Summary */}
        <div className="bg-pink-50/60 p-4 rounded-2xl border border-pink-200 space-y-1.5 text-xs">
          ...
          <div className="flex justify-between text-base font-black text-slate-900 pt-2 border-t border-pink-200">
